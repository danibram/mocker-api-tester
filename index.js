...
app.get('/', function(req, res) {
  ...
  res.write('<h1>mocker-data-generator tester</h1><p>Hey! this is the mocker-data-generator tester. I configured 2 routes (POSTs routes): <br/> <br/> "/schema/:schemaName" you need to send a post and send in the body {schema, options}, is like the schema method of the module. <br/>"/schemas" you need to send an array of schemas [{name, schema, options} ...] <br/><br/>  Have fun!!! <br/><br/> <a href="http://danibram.github.io/mocker-data-generator/"> View documentation </a> </p>');
  res.end();
});
