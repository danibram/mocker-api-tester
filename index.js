...
app.get('/', function(req, res) {
    ...
    <body>
        ...
        <p>
            ...
            <br/>
            <br/> "/schema/:schemaName" you need to send a post and send in the body {schema, options}, is like the schema method
            of the module.
            <br/> "/schemas" you need to send an array of schemas [{name, schema, options} ...]
            <br/>
            <br/> Have fun!!!
            <br/>
            <br/>
            <a href="https://github.com/danibram/mocker-api-tester/"> View api documentation </a>
            <br/>
            <a href="http://danibram.github.io/mocker-data-generator/"> View module documentation </a>
        </p>
        <br/>Using version ${
            package.dependencies['mocker-data-generator']
        } of mocker-data-generator
    </body>
...
app.post('/schemas', function(req, res) {
    ...
    req.body.map(function(sch) {
        if (typeof sch.options === 'object' || parseInt(sch.options) > 0) {
            var opts =
                typeof sch.options === 'object'
                    ? sch.options
                    : parseInt(sch.options)
